...
| `ignorePatterns` | see file | Excludes port-process artifacts (`TS_PORT_*.md`, `TS_EXISTING_REPO_REVIEW.md`, `goal.md`, `typescript_port_process_prompt.md`) that cross-reference each other by line number — reformatting would corrupt those references. |
